...
public:
    ...
    vector<float> SIMPLEX(MATRIX<float> sA, vector<float> sb, vector<float> sc, vector<float> x0){
    ...
    vector<float> SIMPLEX_STANDARD(MATRIX<float> pA, vector<float> bA, vector<int> Bid, vector<float> pC){
        pA.PRINTF();
        MATRIX A = pA;
